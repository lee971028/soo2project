  ...
  <table class="table table-bordered" style="width: 400px;">
   <caption><b>자동차 정보입력</b></caption>
     ...
     <tr>
       <th width="100">색상</th>
         <td>
           <input type="color" name="carcolor" class="form-control" value="#ffccff" style="width: 100px;" required="required">
         </td>
     </tr>
     ...
     <tr>
       <th width="100">구입일</th>
         <td>
           <input type="date" name="carguip" class="form-control" value="2023-04-10" style="width: 250px;" required="required">
         </td>
     </tr>
